...
import galleryBackdrop from '../Logo/about/galereya.png'
...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="section section-alt gallery-section" style={{ '--gallery-bg': `url(${galleryBackdrop})` }}>
      <div className="container">
        <div className="section-screen gallery-screen">
